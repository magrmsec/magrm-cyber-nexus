...
export const SETTINGS_GROUPS: SettingsGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "videosSearchPlaceholder", label: "نص مربع البحث في الفيديوهات", type: "text" },
      { key: "videosMinutesShort", label: "اختصار مدة الفيديو", type: "text" },
      { key: "videosMinutesLabel", label: "تسمية الدقائق", type: "text" },
      { key: "videosRemainingLabel", label: "تسمية الفيديوهات المتبقية", type: "text" },
      { key: "videosYoutubeLinkLabel", label: "رابط مصدر الفيديو", type: "text" },
      { key: "videosLoadingLabel", label: "رسالة تحميل الفيديوهات", type: "text" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "certificatesMainSectionEyebrow", label: "الشهادات — التسمية العلوية", type: "text" },
      { key: "certificatesMainSectionTitle", label: "الشهادات — عنوان القسم الرئيسي", type: "text" },
      { key: "certificatesMainSectionDescription", label: "الشهادات — وصف القسم الرئيسي", type: "textarea" },
      { key: "certificatesMainCountLabel", label: "الشهادات — تسمية العدد", type: "text" },
      { key: "certificatesOpenDetailsLabel", label: "الشهادات — زر فتح التفاصيل", type: "text" },
      { key: "hackviserSectionEyebrow", label: "Hackviser — التسمية العلوية", type: "text" },
      { key: "hackviserSectionTitle", label: "Hackviser — عنوان القسم", type: "text" },
      { key: "hackviserSectionDescription", label: "Hackviser — وصف القسم", type: "textarea" },
      { key: "hackviserOpenDetailsLabel", label: "Hackviser — زر فتح المجموعة", type: "text" },
      { key: "hackviserDetailEyebrow", label: "Hackviser — تسمية صفحة التفاصيل", type: "text" },
      { key: "hackviserDetailTitle", label: "Hackviser — عنوان صفحة التفاصيل", type: "text" },
      { key: "hackviserDetailDescription", label: "Hackviser — وصف صفحة التفاصيل", type: "textarea" },
      { key: "hackviserRecognitionTitle", label: "Hackviser — عنوان الاعتماد", type: "text" },
      { key: "hackviserRecognitionText", label: "Hackviser — نص الاعتماد", type: "textarea" },
      { key: "hackviserSubsectionEyebrow", label: "Hackviser — تسمية الشهادات التابعة", type: "text" },
      { key: "hackviserSubsectionTitle", label: "Hackviser — عنوان الشهادات التابعة", type: "text" },
      { key: "hackviserSubsectionDescription", label: "Hackviser — وصف الشهادات التابعة", type: "textarea" },
      { key: "hackviserCertificateCountLabel", label: "Hackviser — تسمية عدد الشهادات", type: "text" },
      { key: "hackviserCertificateBadge", label: "Hackviser — شارة الشهادة", type: "text" },
    ],
  },
  {
    id: "stats",
...
export const DEFAULT_SETTINGS: SiteSettings = {
  ...
  videosSearchPlaceholder: "ابحث في الفيديوهات… مثال: Nmap، CTF",
  videosMinutesShort: "د",
  videosMinutesLabel: "دقيقة",
  videosRemainingLabel: "متبقية",
  videosYoutubeLinkLabel: "فتح على يوتيوب ←",
  videosLoadingLabel: "جاري تحميل الفيديوهات…",
  ...
  certificatesMainSectionEyebrow: "الشهادات المهنية الرئيسية",
  certificatesMainSectionTitle: "أقوى الشهادات المهنية",
  certificatesMainSectionDescription: "اختر الشهادة لفتح واجهة تفاصيل مستقلة تحتوي الصورة الأصلية والوصف المهني وقوة الاعتماد والمحتوى التابع لها.",
  certificatesMainCountLabel: "شهادات",
  certificatesOpenDetailsLabel: "فتح تفاصيل الشهادة وقوتها واعتمادها",
  hackviserSectionEyebrow: "قسم Hackviser المستقل",
  hackviserSectionTitle: "Hackviser — مجموعة الشهادات المهنية العملية",
  hackviserSectionDescription: "مجموعة مستقلة تضم شهادات Hackviser في عمليات الأمن، اختبار الاختراق، وأمن تطبيقات الويب، مع صفحة تفاصيل تعرض كل شهادة وصورتها ووصفها.",
  hackviserOpenDetailsLabel: "فتح مجموعة Hackviser والشهادات التابعة",
  hackviserDetailEyebrow: "قسم Hackviser المستقل",
  hackviserDetailTitle: "Hackviser — مجموعة الشهادات المهنية العملية",
  hackviserDetailDescription: "قسم مستقل يجمع شهادات Hackviser العملية في عمليات الأمن السيبراني، اختبار الاختراق، وأمن تطبيقات الويب، بحيث تظهر كل شهادة بصورتها ووصفها ومجالات المهارة التي تغطيها.",
  hackviserRecognitionTitle: "قوة المجموعة وطبيعة الاعتماد",
  hackviserRecognitionText: "هذه شهادات مهنية صادرة من Hackviser كما تظهر في الصور والبيانات المتاحة. تُعرض بوضوح كمسارات تدريب وتقييم عملية، ولا تُقدَّم هنا على أنها اعتماد حكومي أو بديل عن الشهادات التنظيمية الرسمية مثل CISSP أو OSCP.",
  hackviserSubsectionEyebrow: "الشهادات التابعة لمجموعة Hackviser",
  hackviserSubsectionTitle: "جميع شهادات Hackviser",
  hackviserSubsectionDescription: "تظهر كل شهادة بصورة مستقلة مع اسمها والمهارات التي تركز عليها، مرتبة من المسارات التخصصية إلى الشهادة التأسيسية.",
  hackviserCertificateCountLabel: "شهادات",
  hackviserCertificateBadge: "الشهادة",
