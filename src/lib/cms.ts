...
export const FIELDS: Record<CmsKind, FieldDef[]> = {
  ...
  certificate: [
    ...
    { key: "description", label: "الوصف التفصيلي في صفحة الشهادة", type: "textarea" },
    { key: "recognition", label: "قوة الشهادة وطبيعة الاعتماد", type: "textarea" },
    { key: "topics", label: "المحاور والمهارات (افصل بفاصلة)", type: "list" },
    { key: "strength", label: "شارة التخصص", type: "text" },
